...
| **FGD** | loss + aligner (아래 단서) | `..._coco_fgd.yaml` | **0.048** | 대기 |
...
| fgd | 117.53 | 96.0% | 0.0477 | **0.048** | 53.8% | 2.90 GB | 10.4 |

네 기법의 초기 KD 비중이 **0.6pt 안에 모였다.** PKD 는 `1 − r` 이라 1 부근에 갇혀 MSE 의 1/8 이고,
