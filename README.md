...
| **AMSE** | loss 만 (FGD ablation, 아래) | `..._coco_amse.yaml` | **0.07** | 대기 |
...
| amse | 79.679 | 94.4% | 0.0687 | **0.07** | 54.0% | 2.80 GB | 10.9 |
...
| AMSE | 0.07 | — | — | — | — | 대기 (FGD ablation, [§4](#amse--fgd-의-attention-가중만-분리한-변형)) |
