...
| 8 | head`.1` × s-COCO × **AMSE** | KD 기법 (FGD ablation) | 대기 |
...
| **AMSE** | loss 만 (FGD ablation, 아래) | `..._coco_amse.yaml` | **0.1** | 대기 |
...
| AMSE | 0.1 | — | — | — | — | 대기 (FGD ablation, [§4](#amse--fgd-의-attention-가중만-분리한-변형)) |
