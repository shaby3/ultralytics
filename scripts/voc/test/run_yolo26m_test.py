"""VOC baseline test — yolo26m best.pt evaluated on test split (test2007)."""
...
if __name__ == "__main__":
    model_path = "runs/detect/voc/train/baseline_yolo26m_100epoch/weights/best.pt"
    ...
    results = model.val(
        ...
        workers=2,
        project="voc/test",
        name="baseline_yolo26m_100epoch_test",
        exist_ok=True,
        device=0,
    )
