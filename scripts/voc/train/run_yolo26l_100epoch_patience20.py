# python scripts/voc/train/run_yolo26l_100epoch_patience10.py
"""VOC baseline training — yolo26l with COCO pretrained weights (converted for pruning-compatible C2f)."""
...
if __name__ == "__main__":
    ...
    model.train(
        ...
        workers=2,
        project="voc/train",
        name="baseline_yolo26l_100epoch",
        patience=20,
        exist_ok=True,
        device=0,
    )
